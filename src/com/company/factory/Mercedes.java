...
public class Mercedes  extends CarStore {
    ...
    public Car createCar(String type) {
        if (type.equals("sedan")) {
            return new MercedesSedan("MercedesSedan",mainBody2,absBrakeSystem,gear6,fuelTypePetrol,
            ...
            return new MercedesRoadster("MercedesRoadster",mainBody3,espBrakeSystem,gear5,fuelTypeDiesel,
